...
public class SupportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View[] array = new View[]{view.findViewById(R.id.tech_no),view.findViewById(R.id.tran_no),
                view.findViewById(R.id.tech_id),view.findViewById(R.id.tran_id)};
        String[] keys = new String[]{"Technical :","Railway :"};
        String[] vals = new String[]{"+919423867235","+919075094956","yashrodkar2@gmail.com","jacktodkar@railways.in"};
        int i;
        TextView key;
        TextView val;
